...
C.root_folder = '/mnt/newdisk/zyy/data/multi/new_California'
# C.A_format = '.png'
# C.B_format = '.png'
# C.gt_format = '.png'
...
C.log_dir = osp.abspath('log_final/California/' + C.backbone  + 'test1')
