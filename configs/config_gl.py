...
# Dataset config
"""Dataset Path"""
C.dataset_name = 'Gloucester'
# C.dataset_path = osp.join(C.root_dir, 'datasets', 'Gloucester')
# C.dataset_path = '/mnt/newdisk/zyy/data/multi/Gloucester'
...
# C.is_test = False
# C.num_train_imgs = 115
# C.num_eval_imgs = 14
# C.num_classes = 2
# C.class_names = ['background', 'change']
C.root_folder = '/mnt/newdisk/zyy/data/multi/Gloucester'
C.A_format = '.png'
C.B_format = '.png'
C.gt_format = '.png'
C.A_eval_format = '.png'
C.B_eval_format = '.png'
C.gt_eval_format = '.png'
C.is_test = False
# C.num_train_imgs = 136
C.num_train_imgs = 136
C.num_eval_imgs = 1
C.num_classes = 2
C.class_names =  ['background', 'change']
...
# C.log_dir = osp.abspath('log_final/log_backbone/Gloucester/' + C.backbone + '_test1')
C.log_dir = osp.abspath('log_final/Gloucester/' + C.backbone  + '_test3')
